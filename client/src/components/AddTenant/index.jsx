...
const AddTenant = () => {
  return (
    <Formik
      initialValues={{ first_name: '', last_name: '', unit_no: '', rent_current: '', rent_starting: '', rent_last_paid: '', rent_status: '', issues: [], email: '' }}
      validationSchema={Yup.object({
        ...
        last_name: Yup.string()
          ...
          .required('Required'),
        unit_no: Yup.number()
          .max(4, 'Must be 20 characters or less')
          .required('Required'),
        rent_current: Yup.number()
          .max(20, 'Must be 20 characters or less')
          .required('Required'),
        rent_starting: Yup.number()
          .max(20, 'Must be 20 characters or less')
          .required('Required'),
